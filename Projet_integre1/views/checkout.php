                     ...
                     $total=$_SESSION['total'];
                      ...
                      ?>
                            ...
                            <?php if($p['QTE']>=500 && $p['prix']*$p['QTE']>=5000 ){    ?>
                              ...
                              <?php $reduction=50; $total=$total-($p['prix']*$p['QTE']*50)/100 ?>
                              <?php $totalF+=$total;
                              ...
                              <?php $reduction=20; $total=$total-($p['prix']*$p['QTE']*20)/100 ?>
                        ...
                        ?>
                            <tr>
                              ...
                              <?php if($totalF==0){$totalD=$_SESSION['total']; ?>
