                  ...
                  <tr>
                    ...
                    <td>
                       <?php foreach ($sth1 as $row) {}?>
                                        ...
                                        if(mysqli_affected_rows($db)!=0)
                                        {?>
                                         <p><?php  $total+=($p['prix']-($p['prix']*$row['tauxReduction'])/100)*$p['QTE'];echo ($p['prix']-($p['prix']*$row['tauxReduction'])/100)*$p['QTE']; ?>DTT</p>

                                        <?php }else{?>
                                        <p><?php  $total+=$p['prix']*$p['QTE'];echo $p['prix']*$p['QTE']; ?>DTT</p>
                                       <?php }
                                        ?>
